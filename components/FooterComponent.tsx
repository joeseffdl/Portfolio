...
export const FooterComponent = () => {
  ...
  return (
    <footer className="full-width border-t-2 h-60">
      <div className="breakout flex flex-col justify-center gap-6">
        ...
        <div className="flex gap-2 items-center">
          <div className="flex items-center gap-0.5">
            ...
            <p className="font-semibold text-xs">{getYear}</p>
          </div>
          <p className="uppercase font-semibold text-xs">Joseph De Leon</p>
        </div>
      </div>
    </footer>
  )
